...
use dev_widgets::pages::{home_page::HOME_PAGE_WIDGET_ENTRY, WIDGETS};
use dev_widgets::widget_entry::WidgetEntry;
use dev_widgets::environment;
        ...
        div {
            ...
            div {
                ...
                div {
                    ...
                    for widget_type in WIDGETS.keys() {
                        div {
                            dev_widgets::components::accordion::Accordion {
                                title: *widget_type,
                                is_open: true,
                                for widget_entry in WIDGETS.get(widget_type).unwrap() {
                                    SidebarListItem {
